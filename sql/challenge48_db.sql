...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 31 mars 2026 à 13:48
...
(2, 'CIPHER — SYSTEM://BREACH', 'Infiltration système : résolvez les 7 couches de sécurité pour extraire les données.', '2479gx', 1000, 'difficile', 'jeux/hugo/cipher.php'),
(3, 'SWITCHBOARD — OVERLOAD', 'Rétablissez le courant en trouvant la combinaison d\'interrupteurs qui allume les 3 lampes témoins.', 'combinaison_gagnante', 400, 'moyen', 'jeux/ulysse/jeux.php'),
(4, 'ENIGMA GRID — RECONSTRUCTION', 'Reconstituez le schéma énergétique fragmenté en manipulant les blocs de données.', 'schema_complet', 600, 'moyen', 'jeux/mael/index.php');
...
(1, 'Charles', 'hugo.cabanes@ynov.com', '$2y$10$bsgb7DsHdBQMib1vKg2QLu12ced8ygMXdk9y0F9x5C4Icrx8rrE46', 'default.png', 0, 0, '2026-03-30 13:58:59'),
(2, 'admin', 'admin@ynov.com', '$2y$10$bsgb7DsHdBQMib1vKg2QLu12ced8ygMXdk9y0F9x5C4Icrx8rrE46', 'default.png', 0, 1, '2026-03-30 13:58:59');
