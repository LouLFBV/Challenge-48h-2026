...
function generatePuzzle(int $difficulty): array {
    ...
    $sets = [
        1 => [
            ...
            [
                'objects'   => ['Livre'=>4, 'Stylo'=>1, 'Cahier'=>3],
                'clues'     => [
                    '1 Livre = 4 Stylo',
                    '1 Cahier + 1 Stylo = 4 kg',
                ],
                'question'  => 'Quel est le poids d\'un <strong>Cahier</strong> ?',
                'answer'    => 3,
                'unit'      => 'kg',
                'hint'      => 'Remplace Livre par des Stylos.',
                'balance_left'  => ['Cahier','Stylo'],
                'balance_right' => ['4kg'],
                'max_points'=> 100,
                'difficulty'=> 'facile',
            ],
            [
                'objects'   => ['Sac'=>9, 'Balle'=>3, 'Boîte'=>6],
                'clues'     => [
                    '1 Sac = 3 Balle',
                    '1 Boîte + 1 Balle = 8 kg',
                ],
                'question'  => 'Quel est le poids d\'une <strong>Boîte</strong> ?',
                'answer'    => 6,
                'unit'      => 'kg',
                'hint'      => 'Exprime tout en Balles.',
                'balance_left'  => ['Boîte','Balle'],
                'balance_right' => ['9kg'],
                'max_points'=> 100,
                'difficulty'=> 'facile',
            ],
        ...
        2 => [
            [
                'objects'   => ['Pêche'=>2, 'Prune'=>3, 'Cerise'=>1],
                'clues'     => [
                    '1 Pêche + 1 Prune = 5 kg',
                    '2 Cerise = 2 kg',
                    '1 Pêche = 3 Cerises',
                ],
                'question'  => 'Quel est le poids d\'une <strong>Prune</strong> ?',
                'answer'    => 3,
                'unit'      => 'kg',
                'hint'      => 'Trouve d\'abord le poids d\'une Cerise.',
                'balance_left'  => ['Pêche','Prune'],
                'balance_right' => ['5kg'],
                'max_points'=> 200,
                'difficulty'=> 'moyen',
            ],
            [
                'objects'   => ['Pierre'=>10, 'Plume'=>2, 'Bois'=>6],
                'clues'     => [
                    '1 Pierre = 5 Plume',
                    '1 Bois + 2 Plume = 10 kg',
                    '1 Pierre + 1 Bois = 16 kg',
                ],
                'question'  => 'Quel est le poids du <strong>Bois</strong> ?',
                'answer'    => 6,
                'unit'      => 'kg',
                'hint'      => 'Convertis Pierre en Plumes pour vérifier.',
                'balance_left'  => ['Bois','Plume','Plume'],
                'balance_right' => ['10kg'],
                'max_points'=> 200,
                'difficulty'=> 'moyen',
            ],
        ...
        3 => [
            [
                ...
                'question'  => 'Quel est le poids de <strong>D</strong> ?',
                'answer'    => 2,
                'unit'      => 'kg',
                'hint'      => 'Trouve B avec la première équation, puis C.',
                'balance_left'  => ['A','A'],
                'balance_right' => ['B','B','B','B'],
                'max_points'=> 350,
                'difficulty'=> 'difficile',
            ],
            [
                'objects'   => ['X'=>12, 'Y'=>6, 'Z'=>3],
                'clues'     => [
                    '1 X = 2 Y',
                    '1 Y = 2 Z',
                    '1 Y = 6 kg',
                ...
                'question'  => 'Quel est le poids de <strong>(X - Y)</strong> ?',
                'answer'    => 6,
                'unit'      => 'kg',
                'hint'      => 'Exprime tout en Z pour simplifier.',
                'balance_left'  => ['X'],
                'balance_right' => ['Y','?'],
                'max_points'=> 350,
                'difficulty'=> 'difficile',
